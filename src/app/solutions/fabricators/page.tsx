...
export default function SteelFabricatorsSection() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Give fabricators a takeoff process that improves confidence without removing human judgment.
            </p>

            <p className="text-gray-400 mb-6">
              VizeEst is designed for steel fabricators who want better takeoff speed,
              better accuracy, and more estimator confidence without replacing the people responsible for the work.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mt-6 mb-6">
              Build estimating strength without changing who owns the number.
            </h2>

            <p className="text-gray-300 mb-6">
              Your team keeps its judgment. VizeEst helps make that judgment faster,
            ...
            <ul className="space-y-3">
              {[
                ...
                "Improves internal trust",
                "Helps scale confidence beyond a few senior people",
              ].map((item, i) => (
  ...
  <div className="rounded-3xl bg-gradient-to-b from-[#1f3a46] to-[#0b2230] p-6 sm:p-5">
    ...
    <div className="rounded-2xl border border-dashed border-[#2a4a58] p-6 sm:p-5">
      ...
      <p className="text-[#8aa6b2] mb-8 max-w-xl leading-relaxed">
        A product-led summary view relevant to fabricators.
      </p>

      {/* BOXES */}
      <div className="grid sm:grid-cols-2 gap-6">
        
        <div className="h-20 rounded-2xl bg-gradient-to-br from-[#1a2e39] to-[#233f4d] border border-[#2a4a58]/40 shadow-inner" />
