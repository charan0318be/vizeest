        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Support detailers who contribute to estimation with stronger visual clarity and coordination.
            </p>

            <p className="text-gray-400 mb-6">
              Detailers who support estimation benefit from seeing scope more clearly,
              reducing manual misses, and staying better aligned with estimators.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mt-6 mb-6">
              Clearer interpretation. Better estimation support.
            </h2>

            <p className="text-gray-300 mb-6">
              When detailers can see and validate structure more clearly,
              their contribution to the estimating workflow becomes more accurate and reliable.
            </p>
            ...
            <ul className="space-y-3">
              {[
                "Reduced manual errors",
                "Better coordination with estimators",
                "Stronger scope understanding",
              ].map((item, i) => (
  ...
  <div className="rounded-3xl bg-gradient-to-b from-[#1f3a46] to-[#0b2230] p-6 sm:p-5">
    ...
    <div className="rounded-2xl border border-dashed border-[#2a4a58] p-6 sm:p-5">
      ...
      <p className="text-[#8aa6b2] mb-8 max-w-xl leading-relaxed">
        Show a detailer-friendly interface with visual scope clarity.
      </p>
