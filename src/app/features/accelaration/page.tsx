        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Accelerate takeoffs without removing estimator judgment from the workflow.
            </p>

            <p className="text-gray-400 mb-6">
              Material takeoffs improve when the estimator can visually verify the structure
              instead of relying only on mental reconstruction from drawings.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mt-6 mb-6">
              Move faster with fewer takeoff doubts.
            </h2>

            <p className="text-gray-300 mb-6">
              A visual workflow helps estimators catch issues earlier, reduce manual errors,
              and move through takeoffs with fewer pauses.
            </p>
  ...
  <div className="rounded-3xl bg-gradient-to-b from-[#1f3a46] to-[#0b2230] p-6 sm:p-5">
    ...
    <div className="rounded-2xl border border-dashed border-[#2a4a58] p-6 sm:p-5">
      ...
      <h3 className="text-2xl font-semibold text-white mb-3">
        Takeoff validation panel
      </h3>

      {/* DESCRIPTION */}
      <p className="text-[#8aa6b2] mb-8 max-w-xl leading-relaxed">
        Use a product visual that reinforces clarity and control.
      </p>

      {/* BOXES */}
      <div className="grid sm:grid-cols-2 gap-6">
        
        <div className="h-36 rounded-2xl bg-gradient-to-br from-[#1a2e39] to-[#233f4d] border border-[#2a4a58]/40 shadow-inner" />
