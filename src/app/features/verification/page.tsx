        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Help estimators verify what they are pricing before the number leaves the desk.
            </p>

            <p className="text-gray-400 mb-6">
              This is where VizeEst stands apart. Estimators stay in control, but they no longer
              have to rely only on flat interpretation when building confidence in scope and quantity.
            </p>
  ...
  <div className="relative bg-[#102130] border border-white/[0.08] rounded-3xl p-4 shadow-2xl">
    ...
    <div className="border border-dashed bg-[#172636] border-white/10 rounded-2xl p-6">
      ...
      <h3 className="text-xl font-semibold text-white mb-3">
        2D to 3D verification workspace
      </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mt-6 mb-6">
              See more before you price more.
            </h2>

            <p className="text-gray-300 mb-4">
              The more clearly your team understands the structure, the easier it becomes
              to estimate with confidence and reduce manual errors.
            </p>

            <p className="text-gray-400 mb-6">
              This improves trust in the workflow without taking ownership away from the estimator.
            </p>

            {/* LIST */}
            <ul className="space-y-3">
              {[
                "2D to 3D estimator verification",
                "Reduced manual errors",
                "Seeing is believing",
              ].map((item, i) => (
  ...
  <div className="rounded-3xl bg-gradient-to-b from-[#1f3a46] to-[#0b2230] p-6 sm:p-5">
    ...
    <div className="rounded-2xl border border-dashed border-[#2a4a58] p-6 sm:p-5">
      ...
      <h3 className="text-2xl font-semibold text-white mb-3">
       Drawing to structure view
      </h3>

      {/* DESCRIPTION */}
      <p className="text-[#8aa6b2] mb-8 max-w-xl leading-relaxed">
       Show the transformation from plan sheet to understandable model context.
      </p>
