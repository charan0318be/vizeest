...
export default function QuoteReadinessSection() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Reach pricing with stronger internal confidence.
            </p>

            <p className="text-gray-400 mb-6">
              The estimator still owns the quote. VizeEst simply helps them reach that point
              with more clarity, better verification, and less doubt.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mt-6 mb-6">
              Prepare quotes from a stronger footing.
            </h2>

            <p className="text-gray-300 mb-6">
              A better verification workflow leads to better pricing confidence
              and easier internal alignment.
            </p>
