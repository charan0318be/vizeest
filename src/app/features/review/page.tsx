...
export default function ReviewConfidenceSection() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Make the estimating workflow easier to understand, defend, and trust internally.
            </p>

            <p className="text-gray-400 mb-6">
              The estimator remains central, but the workflow becomes easier for others
              to follow, review, and validate.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mt-6 mb-6">
              A workflow others can trust faster.
            </h2>

            <p className="text-gray-300 mb-6">
              Review becomes more efficient when the reasoning is supported by a clearer
              visual basis and reduced manual errors.
            </p>
  ...
  <div className="rounded-3xl bg-gradient-to-b from-[#1f3a46] to-[#0b2230] p-6 sm:p-5">
    ...
    <div className="rounded-2xl border border-dashed border-[#2a4a58] p-6 sm:p-5">
      ...
      <p className="text-[#8aa6b2] mb-8 max-w-xl leading-relaxed">
       Show pricing confidence with visual verification support.
      </p>
