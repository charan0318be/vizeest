...
export default function BookDemo() {
  ...
  return (
    <section className="bg-[#061a24] text-white py-16 px-4 sm:px-6 lg:px-16">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-start">

        {/* LEFT SIDE */}
        <div>
          <button className="border border-[#2c4a57] text-sm px-4 py-1 rounded-full mb-6">
            CONTACT SALES
          </button>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={i}
                className="border border-[#2c4a57] rounded-2xl px-6 py-5 hover:bg-[#0b2230] transition cursor-pointer"
              >
                {item}
              </div>
            ))}
        ...
        {/* RIGHT SIDE FORM */}
        <div className="bg-[#0b2230] border border-[#1b3440] rounded-3xl p-6 sm:p-8 shadow-xl">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full mt-2 p-3 rounded-xl bg-[#061a24] border border-[#1b3440] focus:outline-none"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full mt-2 p-3 rounded-xl bg-[#061a24] border border-[#1b3440]"
            />
          </div>
          ...
          {/* BUTTON */}
          <button className="w-full bg-white text-black py-3 rounded-full font-medium hover:bg-gray-200 transition">
            Request Demo
          </button>
        </div>
      </div>
