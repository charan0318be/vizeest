  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center z-10">
        ...
        <Link
          href="/pricing"
          className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-gradient-to-r from-[#4EBABD]/20 to-[#2C7181]/20 border border-[#4EBABD]/40 mb-8 animate-fade-in backdrop-blur-sm hover:border-[#4EBABD] transition-all group"
        >
          ...
          <span className="text-sm text-white font-medium">Founder Accelerator Program</span>
          <span className="px-3 py-1 text-xs bg-[#4EBABD] text-white rounded-full font-bold">75% OFF</span>
          <svg className="w-4 h-4 text-[#4EBABD] group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <p className="text-lg sm:text-xl text-[#9CA3AF] max-w-3xl mx-auto mb-10 animate-fade-in-up leading-relaxed" style={{ animationDelay: '0.2s' }}>
          ...
          <span className="text-white">Win more bids with AI-powered steel estimation.</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <button onClick={openModal} className="btn btn-secondary text-lg px-8 py-4 backdrop-blur-sm flex items-center gap-2">
        ...
        {/* Social Proof */}
        <p className="text-sm text-[#6B7280] mb-6 animate-fade-in-up" style={{ animationDelay: '0.35s' }}>
          Trusted by 500+ steel fabricators worldwide
        </p>

        {/* Stats */}
        <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          {[
            { value: '90%', label: 'Faster Estimates' },
            { value: '20hrs', label: 'Saved Weekly' },
            { value: '$50K+', label: 'Average ROI' },
          ].map((stat, i) => (
